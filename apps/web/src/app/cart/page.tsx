...
export default function CartPage() {
  ...
  return <main><SiteHeader /><section className="mx-auto max-w-[1200px] px-5 py-14 lg:px-10 lg:py-20">
    ...
    {items.length === 0 ? <div className="mt-10 surface p-12 text-center"><p className="font-display text-3xl">Your basket is waiting.</p><p className="mt-3 text-sm text-ink/50">Explore considered pieces made to remain.</p><Link href="/shop" className={cn(buttonVariants({ variant: "primary", size: "lg" }), "mt-7")}>Explore the collection</Link></div> :
