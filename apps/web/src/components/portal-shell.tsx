...
import { Bell, Boxes, Building2, ChartNoAxesCombined, CircleUserRound, FileText, Heart, LayoutDashboard, PackageCheck, Search, Settings, ShoppingBag, Store, UsersRound, Waypoints } from "lucide-react";
import { BrandMark } from "@/components/brand-mark";

type PortalKind = "account" | "trade" | "agent" | "admin";

const menus: Record<PortalKind, Array<[string, string, React.ElementType]>> = {
  account: [["Overview", "/account", LayoutDashboard], ["Orders", "/account/orders", ShoppingBag], ["Favourites", "/account/favourites", Heart], ["Profile", "/account/profile", CircleUserRound]],
