...
export class OrdersController {
  ...
  @Post() @ApiHeader({ name: "Idempotency-Key", required: true }) create(@Body() body: CreateOrderDto, @Headers("idempotency-key") key: string) { return this.orders.create(body, key); }
}
